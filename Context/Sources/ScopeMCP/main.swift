...
/// Opens the same database used by the Scope app.
func openDatabase() throws -> DatabaseQueue {
    let appSupportURL = FileManager.default.urls(
        for: .applicationSupportDirectory,
        in: .userDomainMask
    ).first!.appendingPathComponent("Scope", isDirectory: true)

    let dbPath = appSupportURL.appendingPathComponent("scope.db").path
    guard FileManager.default.fileExists(atPath: dbPath) else {
        throw MCPError(message: "Scope database not found at \(dbPath). Launch Scope first.")
    }
...
/// Writes a status file so the Scope GUI can show an MCP connection indicator.
...
// MARK: - Query Preprocessor (duplicated from Scope module — ScopeMCP cannot import it)
...
class MCPServer {
    ...
    init(db: DatabaseQueue) {
        ...
        if let name = foundName {
            FileHandle.standardError.write("ScopeMCP: detected project '\(name)' from \(cwd)\n".data(using: .utf8)!)
        } else {
            FileHandle.standardError.write("ScopeMCP: no project matched for \(cwd)\n".data(using: .utf8)!)
        }
    ...
    func handleRequest(_ req: JSONRPCRequest) -> [String: Any] {
        ...
        case "initialize":
            return successResponse(id: req.id, result: [
                ...
                "capabilities": ["tools": [:]],
                "serverInfo": ["name": "scope", "version": "1.0.0"]
            ])
    ...
    func toolDefinitions() -> [[String: Any]] {
        [
            ...
            [
                "name": "list_projects",
                "description": "List all projects tracked by Scope",
                "inputSchema": [
                    "type": "object",
                    "properties": [:] as [String: Any]
                ]
            ...
            [
                ...
                "description": "Navigate the browser to a URL. Opens a new tab if none are open. Waits for page load to complete. Requires Scope to be running.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                ...
                "description": "Get the accessibility tree of the current page as compact structured text. Returns ARIA roles, labels, and interactive element refs. This is the primary tool for understanding page content and structure. Requires Scope to be running.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                ...
                "description": "Extract text content from a page element using a CSS selector. Returns the text content of the first matching element. Requires Scope to be running.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                ...
                "description": "List all open browser tabs with their URLs, titles, and loading state. Requires Scope to be running.",
                "inputSchema": [
                    "type": "object",
                    "properties": [:] as [String: Any]
                ] as [String: Any]
            ...
            [
                ...
                "description": "Get JavaScript console log entries (log, warn, error, info) from a browser tab. Useful for debugging web applications. Requires Scope to be running.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
                        "tab_id": ["type": "string", "description": "Tab ID (defaults to active tab)"],
            ...
            [
                ...
                "description": "Take a PNG screenshot of the current page. Returns the file path so you can read the image. Requires Scope to be running.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
                        "tab_id": ["type": "string", "description": "Tab ID (defaults to active tab)"]
            ...
            [
                ...
                "description": "Open a new browser tab. Optionally navigate to a URL. Requires Scope to be running.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                ...
                "description": "Close a browser tab by its ID. Requires Scope to be running.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                ...
                "description": "Switch the active browser tab to the specified tab. Requires Scope to be running.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                "name": "browser_click",
                "description": "Click an element by its ref from browser_snapshot. Automatically scrolls into view first. Requires Scope to be running with the browser tab visible.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                "name": "browser_type",
                "description": "Type text into an input or textarea element by ref. Clears existing content by default. Works with React and other framework-controlled inputs. Requires Scope to be running with the browser tab visible.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                "name": "browser_select",
                "description": "Select an option from a <select> dropdown by value or visible label text. On mismatch, returns all available options. Requires Scope to be running with the browser tab visible.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                "name": "browser_scroll",
                "description": "Scroll the page by direction/amount, or scroll a specific element into view. Returns scroll position info. Requires Scope to be running with the browser tab visible.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                "name": "browser_wait",
                "description": "Wait for an element to appear on the page. Use after clicking something that triggers async loading. Accepts ref or CSS selector. Returns found status, not an error on timeout. Requires Scope to be running with the browser tab visible.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                "name": "browser_press",
                "description": "Press a key or key combination. Targets a specific element by ref, or the currently focused element if no ref is provided. Handles Enter (submits forms), Tab (moves focus), Escape, arrow keys, and any single character. Requires Scope to be running with the browser tab visible.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                "name": "browser_eval",
                "description": "Execute JavaScript on the page and return the result. The expression runs inside an async function body, so use 'return' to return values and 'await' for promises. Use for reading page state, calling APIs, or handling edge cases other tools can't cover. Requires Scope to be running with the browser tab visible.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                "name": "browser_hover",
                "description": "Hover over an element by ref. Dispatches mouseenter and mouseover events. Useful for dropdown menus, tooltips, and hover-state UI that requires mouse presence. Scrolls element into view first. Requires Scope to be running with the browser tab visible.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
                        "ref": ["type": "string", "description": "Element ref from browser_snapshot"],
            ...
            [
                "name": "browser_upload",
                "description": "Set a file on an <input type='file'> element. Reads the file from disk, encodes it, and assigns it to the input. Triggers change and input events. Requires Scope to be running with the browser tab visible.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                "name": "browser_drag",
                "description": "Drag an element to a target element using HTML5 drag and drop events. Dispatches the full drag event sequence: dragstart, drag, dragenter, dragover, drop, dragend. Requires Scope to be running with the browser tab visible.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                "name": "browser_iframe",
                "description": "Switch execution context to an iframe for subsequent commands (snapshot, click, type, etc.), or back to the main frame. Call with a ref to enter an iframe, or without ref to return to main frame. Only same-origin iframes are accessible. Use browser_snapshot to see available iframes. Requires Scope to be running with the browser tab visible.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                ...
                "description": "Clear browsing data (cookies, cache, localStorage). Useful for resetting login state, clearing cached data, or testing fresh page loads. Clears all data by default. Requires Scope to be running.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
                        "types": [
            ...
            [
                ...
                "description": "Get cookies for the current page, including httpOnly cookies not visible to JavaScript. Useful for debugging authentication, session management, and tracking. Requires Scope browser.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                ...
                "description": "Read localStorage or sessionStorage contents. Returns item count, key-value pairs, and total size in bytes. Requires Scope browser.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                ...
                "description": "Set a cookie on the current page. Useful for testing auth flows, spoofing sessions, or setting feature flags. Requires Scope browser.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
            ...
            [
                "name": "generate_image",
                "description": "Generate an image from a text prompt using AI (Gemini 3.1 Flash). Returns the file path of the generated image saved to the project's assets/generated/ directory. Requires OpenRouter API key configured in Scope settings.",
                "inputSchema": [
                    "type": "object",
                    "properties": [
    ...
    func contextSearch(_ args: [String: Any]?) throws -> String {
        ...
        let appDefaults = UserDefaults(suiteName: "com.scope.app")
    ...
    private func callOpenRouterImageGeneration(messages: [[String: Any]], aspectRatio: String, imageSize: String) throws -> (imageData: Data, responseText: String?) {
        ...
        guard !apiKey.isEmpty else {
            throw MCPError(message: "OpenRouter API key not configured. Set it in Scope Settings > Context Engine.")
        }
    ...
    private func saveGeneratedImage(
        ...
        if let projectPath, !projectPath.isEmpty {
            ...
            let appSupport = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first!
                .appendingPathComponent("Scope/generated-images", isDirectory: true)
            saveDir = appSupport
        }
