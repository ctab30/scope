...
class UpdateService: ObservableObject {
    ...
    func checkForUpdate(owner: String, repo: String) async {
        ...
        request.setValue("Workspace/\(currentVersion)", forHTTPHeaderField: "User-Agent")
    ...
    func downloadAndInstall(owner: String, repo: String) async {
        ...
        do {
            ...
            let tempDir = FileManager.default.temporaryDirectory.appendingPathComponent("WorkspaceUpdate-\(UUID().uuidString)")
