    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            ScrollViewReader { proxy in
                ScrollView {
                    LazyVStack(alignment: .leading, spacing: WorkspaceTheme.Spacing.md) {
...
private struct ChatSettingsPopover: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: WorkspaceTheme.Spacing.md) {
            Text("Chat Settings")
                .font(WorkspaceTheme.Font.bodySemibold)
            ...
            GroupBox("Model") {
                VStack(alignment: .leading, spacing: WorkspaceTheme.Spacing.xxs) {
                    ...
                    Text("Configure in Settings \u{2192} AI Engine")
                        .font(WorkspaceTheme.Font.caption)
                        .foregroundStyle(.tertiary)
                }
                .padding(WorkspaceTheme.Spacing.xxs)
            }
