...
struct FileBrowserView: View {
    ...
    private var treePanel: some View {
        VStack(spacing: 0) {
            ...
            .cornerRadius(WorkspaceTheme.Radius.small)
            ...
            if isBinary {
                ...
                VStack(spacing: 0) {
                                ...
                                Text(lang)
                                    ...
                                    .background(
                                        RoundedRectangle(cornerRadius: WorkspaceTheme.Radius.small)
                                            .fill(WorkspaceTheme.Colors.separator.opacity(WorkspaceTheme.Opacity.border))
                                    )
                            }
                            Spacer()
                    ...
                    if isTruncated {
                        ...
                        .background(Color.white.opacity(WorkspaceTheme.Opacity.hover))
                    }
