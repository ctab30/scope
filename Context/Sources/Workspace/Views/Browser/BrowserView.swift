...
struct BrowserView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Rectangle()
                .fill(WorkspaceTheme.Colors.separator.opacity(0.5))
                .frame(height: 1)
            ...
            TextField("Enter URL", text: $urlText)
                ...
                .background(
                    Capsule(style: .continuous)
                        .fill(WorkspaceTheme.Colors.textBg)
                )
                .overlay(
                    Capsule(style: .continuous)
                ...
                Image(systemName: "hammer")
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: WorkspaceTheme.Radius.small)
                            .fill(showDevTools ? Color.accentColor.opacity(WorkspaceTheme.Opacity.selection) : Color.clear)
                    )
                    .contentShape(Rectangle())
            }
            .buttonStyle(.plain)
    ...
    private func saveScreenshot(_ image: NSImage) {
        ...
        let appSupport = FileManager.default.urls(
            ...
            in: .userDomainMask
        ).first!.appendingPathComponent("Workspace/browser-screenshots", isDirectory: true)
