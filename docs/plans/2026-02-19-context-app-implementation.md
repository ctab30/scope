...
- Organization Identifier: `com.connor`
- Interface: SwiftUI
- Language: Swift
...
class ProjectDiscovery {
    ...
    func discoverProjects() throws -> [Project] {
        ...
        for dir in contents where dir.hasDirectoryPath {
            ...
            // e.g. "-Users-connor-Documents-augment-projects-Fixed-Ops-Pro"
...
class MCPServer {
    ...
    private let queue = DispatchQueue(label: "com.scope.mcp", qos: .utility)
...
class ContextInjector {
    ...
    func updateClaudeMD(for project: Project) throws {
        ...
        let marker = "<!-- Scope.app managed section -->"
        let endMarker = "<!-- End Scope.app section -->"

        let section = """
        \(marker)
        # Context
        This project uses Scope.app for session memory.
