...
**Goal:** Add a Recordings tab to Scope.app that records meetings (system audio + mic), auto-transcribes with WhisperKit, extracts tasks via Claude CLI, and lets users review/approve tasks onto the kanban board.
...
Run: `cd Context && .build/debug/Scope.app/Contents/MacOS/Context &`
